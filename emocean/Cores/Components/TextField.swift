...
//  emocean
//
//  Created by Wilson Adrilia on 29/07/2021.
//
...
struct MultilineTextField: View {
    ...
    @State private var dynamicHeight: CGFloat = 340
...
//            Text("Description:")
            MultilineTextField(text: testBinding, onCommit: {
                print("Final text: \(test)")
            })
            Spacer()
        }
        .padding()
        .background(Color.theme.sunsetBottomGradient)
        .previewLayout(.fixed(width: 360, height: 365))
    }
}
#endif
